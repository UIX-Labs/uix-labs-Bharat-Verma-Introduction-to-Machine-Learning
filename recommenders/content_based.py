...
def extract_title(title):
    ...
    # some movies do not have the info about the year in the column title.
    # So, we should take care of the case as well.
    if year.isnumeric():
...
def content_based_recommendation(movie):
    ...
    # a function to return the most similar title to the words a user types
